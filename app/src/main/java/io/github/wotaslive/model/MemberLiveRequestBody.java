package io.github.wotaslive.model;

/**
 * Created by codeczx on 2017/10/10.
 */

public class MemberLiveRequestBody {
    ...
    public MemberLiveRequestBody(int lastTime, int groupId, int type, int memberId, int limit, long giftUpdTime) {
