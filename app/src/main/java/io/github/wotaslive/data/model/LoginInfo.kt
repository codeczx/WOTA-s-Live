 ...
 * Class description:
 */
data class LoginInfo(var status: Int = 0,
                     var message: String? = null,
                     var content: ContentBean? = null) {

    data class ContentBean(var userInfo: UserInfoBean? = null,
         ...
         * role : 0
         */
        data class UserInfoBean(var userId: Int = 0,
        ...
        data class BindInfoBean(var type: Int = 0,
